...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | user-login-login-module */[__webpack_require__.e("default~childes-childes-module~user-forgot-password-forgot-password-module~user-login-login-module"), __webpack_require__.e("default~user-forgot-password-forgot-password-module~user-login-login-module"), __webpack_require__.e("user-login-login-module")]).then(__webpack_require__.bind(null, /*! ./user/login/login.module */ "./src/app/user/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'forgot-password',
        loadChildren: () => Promise.all(/*! import() | user-forgot-password-forgot-password-module */[__webpack_require__.e("default~childes-childes-module~user-forgot-password-forgot-password-module~user-login-login-module"), __webpack_require__.e("default~user-forgot-password-forgot-password-module~user-login-login-module"), __webpack_require__.e("user-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./user/forgot-password/forgot-password.module */ "./src/app/user/forgot-password/forgot-password.module.ts")).then(m => m.ForgotPasswordPageModule)
    },
    {
        path: 'tabs',
...
/* harmony import */ var _providers_language_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./providers/language.service */ "./src/app/providers/language.service.ts");
/* harmony import */ var _providers_login_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./providers/login.service */ "./src/app/providers/login.service.ts");
...
/* harmony import */ var _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/fcm/ngx */ "./node_modules/@ionic-native/fcm/__ivy_ngcc__/ngx/index.js");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, storage, Router, LanguageService, LoginService, network, toastController, translate, fcm) {
    ...
    ngOnInit() {
        ...
        this.Subscription = this.LanguageService.language.subscribe(langVal => {
...
/* harmony import */ var _components_language_language_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/language/language.component */ "./src/app/components/language/language.component.ts");
/* harmony import */ var _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/fcm/ngx */ "./node_modules/@ionic-native/fcm/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_language_language_component__WEBPACK_IMPORTED_MODULE_15__["LanguageComponent"],
        ],
        entryComponents: [
            _components_language_language_component__WEBPACK_IMPORTED_MODULE_15__["LanguageComponent"],
        ],
...
/* harmony import */ var src_app_providers_language_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/providers/language.service */ "./src/app/providers/language.service.ts");
...
let LanguageComponent = class LanguageComponent {
    constructor(popoverController, storage, LanguageService) {
...
LanguageComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./language.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/language/language.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./language.component.scss */ "./src/app/components/language/language.component.scss")).default]
    })
], LanguageComponent);
...
const BACKEND_API = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].API_URL + '/login/';
...
module.exports = __webpack_require__(/*! /home/darkside/Desktop/school/school-app/src/main.ts */"./src/main.ts");
