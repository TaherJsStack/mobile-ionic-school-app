  ...
  function srcAppPagesTabsTabsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | childes-childes-module */
          [__webpack_require__.e("default~childes-childes-module~user-forgot-password-forgot-password-module~user-login-login-module"), __webpack_require__.e("childes-childes-module")]).then(__webpack_require__.bind(null,
          /*! ../childes/childes.module */
          "./src/app/pages/childes/childes.module.ts")).then(function (m) {
            return m.ChildesPageModule;
          });
        }
      }, {
        path: 'notifications',
